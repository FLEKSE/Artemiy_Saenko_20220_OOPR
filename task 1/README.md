...
Программа позволяет создавать, сохранять, открывать и редактировать таблицы расширения .csv. Если пользователь ошибся при вводе, то при нажатии кнопки "Добавить" ему будет показано окно ошибки с кнопкой, позволяющей закрыть это окно. Если пользователь ввёл корректные данные, то они будут добавлены в таблицу.
